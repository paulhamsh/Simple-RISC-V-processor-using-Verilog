...
add_files -fileset sim_1 $DIR/src/testbench_data_word_memory.v 
add_files -fileset sim_1 $DIR/src/testbench_data_word_memory_integrated.v 
add_files -fileset sim_1 $DIR/src/testbench_data_word_memory_integrated_behav.wcfg 
