...
add_files -fileset sim_1 $DIR/src/testbench_immediates.v 
add_files -fileset sim_1 $DIR/src/testbench_immediates_integrated.v 
add_files -fileset sim_1 $DIR/src/testbench_immediates_integrated_behav.wcfg 
