...
add_files -fileset sim_1 $DIR/src/testbench_branch.v 
add_files -fileset sim_1 $DIR/src/testbench_branch_integrated.v 
add_files -fileset sim_1 $DIR/src/testbench_branch_integrated_behav.wcfg 
